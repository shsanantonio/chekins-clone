          ...
          <div className="space-y-4 pt-4 md:pt-0 md:space-y-2 md:w-1/2">
            ...
            <ul className="list-disc px-4  leading-7 text-[15px] 2xl:text-[18px]">
              <li className="  font-[400] text-[#5C6A7A] md:text-left">
                <span className="">
                  Personalized &amp; curated search results and recommendations
                  based on your profile, travel history, and interests
                </span>
              </li>
              <li className="   font-[400] text-[#5C6A7A] md:text-left">
                <span className="">
                  Auto-Rebook feature that automatically refunds you any price
                  difference if rates drop, ensuring maximum savings.
                </span>
              </li>
              <li className=" text-[#5C6A7A] font-[400] md:text-left ">
                <span className="">
                  Lowest prices that save you up to 40% compared to other online
                  booking platforms.
                </span>
              </li>
              <li className="   font-[400] text-[#5C6A7A] md:text-left">
                <span className="">
                  No hidden fees and exceptional value through exclusive
                  member-only rates and unparalleled savings.
                </span>
              </li>
            </ul>
          </div>
